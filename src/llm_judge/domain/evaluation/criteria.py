...
class DefaultCriteria:
    ...
    def comprehensive() -> EvaluationCriteria:
        """Create comprehensive default criteria covering all major dimensions."""
        criteria = [
            # Factual criteria
            CriterionDefinition(
                name="accuracy",
        ...
        return EvaluationCriteria(
            ...
            description="Complete multi-dimensional assessment covering accuracy, completeness, clarity, relevance, helpfulness, coherence, and appropriateness"
        )
    
    @staticmethod
    def basic() -> EvaluationCriteria:
        """Create basic criteria for simple evaluations."""
        criteria = [
            CriterionDefinition(
                name="accuracy",
        ...
        return EvaluationCriteria(
            ...
            description="Simple three-dimensional assessment focusing on core quality aspects"
        )
    
    @staticmethod
    def technical() -> EvaluationCriteria:
        """Create criteria optimized for technical content evaluation."""
        criteria = [
            CriterionDefinition(
        ...
        return EvaluationCriteria(
            ...
            description="Specialized evaluation for technical content and solutions"
        )
    
    @staticmethod
    def creative() -> EvaluationCriteria:
        """Create criteria for creative and subjective content."""
        criteria = [
            CriterionDefinition(
                name="creativity",
...
class CriteriaBuilder:
    ...
    def add_factual_criterion(self, name: str, description: str, weight: float = 1.0) -> 'CriteriaBuilder':
        """Add a factual accuracy criterion."""
        self.criteria.append(CriterionDefinition(
            name=name,
    ...
    def add_quality_criterion(self, name: str, description: str, weight: float = 1.0) -> 'CriteriaBuilder':
    ...
    def add_linguistic_criterion(self, name: str, description: str, weight: float = 1.0) -> 'CriteriaBuilder':
