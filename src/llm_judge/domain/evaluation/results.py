...
class MultiCriteriaResult:
    ...
    def update_criterion_score(
        self, criterion_name: str, score: int, reasoning: str, confidence: float = 0.0
    ):
            ...
            summary.update(
                {
                    ...
                    "score_range": [
                        self.aggregated.min_score,
                        self.aggregated.max_score,
                    ],
                }
            )
    ...
    def to_legacy_format(self) -> Dict[str, Any]:
        ...
        return {
            ...
            or f"Multi-criteria evaluation with {len(self.criterion_scores)} criteria",
